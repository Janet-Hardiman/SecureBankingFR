...
/* Use the eigen.cache containing eigenfaces, eigenvalues, and training
   ...
   This code recognises an image from a still image to compare to the training images

   Modified by Janet Hardiman, April 2017 to take an image from the webcam & compare to the training images
*/
